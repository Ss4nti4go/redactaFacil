...
// Configuración de Mercado Pago con el Access Token correcto
  ...
  try {
    ...
    const result = await preference.create({
      body: {
        ...
        back_urls: {
          success: `${process.env.FRONTEND_URL || "https://redactafacil.vercel.app"}/success.html`,
          failure: `${process.env.FRONTEND_URL || "https://redactafacil.vercel.app"}/failure.html`,
          pending: `${process.env.FRONTEND_URL || "https://redactafacil.vercel.app"}/pending.html`,
        },
  ...
  try {
    ...
    if (type === "payment") {
      ...
      if (payment.status === "approved") {
        ...
        console.log(`Usuario ${userId} actualizado a Premium:`, updatedUser)
      }
    }
...
// Conexión a MongoDB
mongoose
  .connect(process.env.MONGODB_URI || "mongodb://localhost:27017/redactafacil")
